...
import {
    DollarSign, TrendingUp, ArrowUpRight, Clock,
...
const Expenses = () => {
    ...
    useEffect(() => {
        const fetchHistory = async () => {
            try {
                ...
                const passengerRides = data.filter(ride =>
                    ride.passenger?._id === user?._id || ride.passenger === user?._id
                );
    ...
    return (
        <div className="w-full space-y-5 animate-in fade-in duration-500">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tight">Spending History</h1>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mt-1">Track your ride expenses</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5">
                    <div className="flex items-center gap-2 mb-3">
                        <div className="p-2 rounded-xl bg-rra-blue/10">
                            <DollarSign size={15} className="text-rra-blue" />
                        </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Tax Paid</p>
                    </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-gray-50 dark:bg-gray-900/40">
                                ...
                                <th className="px-8 py-5 text-xs font-black text-gray-400 uppercase tracking-widest">Amount Paid</th>
                                <th className="px-8 py-5 text-xs font-black text-gray-400 uppercase tracking-widest">Tax</th>
                            ...
                            {paginated.length > 0 ? (
                                paginated.map((item, index) => (
                                    <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                        ...
                                        <td className="px-8 py-5">
                                            <span className={`px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider whitespace-nowrap ${
                                ...
                                <tr>
                                    <td colSpan={6} className="px-8 py-16 text-center">
                                        ...
                                        <p className="text-sm font-bold text-gray-500 dark:text-gray-400">
                                            {searchQuery ? `No records match "${searchQuery}"` : 'No spending records for this period'}
                                        </p>
                                        {searchQuery && (
